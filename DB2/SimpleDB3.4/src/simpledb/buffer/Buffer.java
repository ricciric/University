...
public class Buffer {
   ...
   public long getUnpinTime(){return unpinTimestamp;}

   public void setUnpinTimestamp(long l){this.unpinTimestamp = l;}

   public long getLoadTime(){return this.loadTimestamp;}

   public void setLoadtime(long l){this.loadTimestamp = l;}
